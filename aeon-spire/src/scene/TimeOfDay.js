...
export const TOD_PRESETS = [
  {
    ...
    fogColor: C(0xc8b0a0), fogNear: 320, fogFar: 3000,
  ...
  },
  {
    ...
    sunColor: C(0xfff6e6), sunIntensity: 3.4,
    fillColor: C(0xa8c4e8), fillIntensity: 0.55,
    hemiSky: C(0xc6dcf0), hemiGround: C(0x5a5346), hemiIntensity: 1.15,
    ...
    fogColor: C(0xc8dcec), fogNear: 620, fogFar: 4200,
    exposure: 1.0, grade: C(0xffffff), lift: C(0x000000), contrast: 1.04,
    saturation: 1.05, vignette: 0.36, bloomStrength: 0.5, bloomThreshold: 0.92,
  ...
  },
  {
    ...
    sunColor: C(0xffc077), sunIntensity: 2.7,
    ...
    fogColor: C(0xe0b487), fogNear: 420, fogFar: 3400,
    exposure: 1.08, grade: C(0xfff0d8), lift: C(0x0c0a06), contrast: 1.08,
    saturation: 1.16, vignette: 0.44, bloomStrength: 0.86, bloomThreshold: 0.72,
  ...
  },
  {
    ...
    fogColor: C(0x6f6478), fogNear: 300, fogFar: 2800,
  ...
  },
  {
    ...
    fogColor: C(0x151a28), fogNear: 260, fogFar: 2600,
